...
## Висновок: необхідно орієнтуватися на країни-постачальникі, які мають найбільшу кількість виробників та найкращий рейтинг. А саме,США, Франція, Італія, Шверцарія, Канада, Великобританія Це забезпечить помірну вартість та відповідну якість. При виборі асортименту необхідно орієнтуватися на то-5 популярніших різновидів сирів(Camembert,Parmesan,Pecorino,Gouda,Brie,Cheddar,Blue) та тор-5 найексклюзивніших видів сирів( для забезпечення задоволення клієнтів різних потреб. Для більш виняткового асортименту необхідно реалізовувати сири, які виготовлені з різниої сировини(молоко), не забуваючи про найексклюзивнішу сировину(молоко віслюка, лося, яка, верблюда та рослинної основи). ДЛя підтримання популярного наряму у харчуванні та способу життя необхідно мати у асортименті вегетаріанськи сири- при дослідженні виявлено достатньо країн-ваиробників (СШа, Австралія, Англія, ірландія, Великобританія) та веганські сири- знайдена лише одна крїна-виробник Великобританія.
